...
Bug I couldn't reproduce, I keep the workaround "just in cas": MariaDB misplaces by default the mysqld.sock location, so change the "sock" lines (in /etc/mysql/my.cnf) to /tmp/mysqld.sock
